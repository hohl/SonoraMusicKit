...
/**
 Types of charts which can get retrieven with retrieveChart:limit:completionHandler method.
 */
typedef NSString const* SMKChartType;
FOUNDATION_EXTERN SMKChartType SMKChartHypedArtists;
FOUNDATION_EXTERN SMKChartType SMKChartHypedTracks;
FOUNDATION_EXTERN SMKChartType SMKChartTopArtists;
FOUNDATION_EXTERN SMKChartType SMKChartTopTracks;
